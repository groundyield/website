# Field kit — offline pack (print + phone)

**Use when signal is bad.** Print what you need before the leg; keep PDFs on the phone.

| Asset | Format | Use |
|-------|--------|-----|
| [GroundYield_Field_OnePager_EN_PT.pdf](GroundYield_Field_OnePager_EN_PT.pdf) | PDF · 2 pp | First contact: community leader, partner, supplier |
| [GroundYield_Field_Forms_EN_PT.pdf](GroundYield_Field_Forms_EN_PT.pdf) | PDF · multi | Consent card + interview prompts + baseline blanks |
| [INTERVIEW.md](INTERVIEW.md) | Markdown | Full interview scripts (EN notes + PT prompts) |
...
- Baseline **before** any impact claim  
- Local yields, not national averages  
