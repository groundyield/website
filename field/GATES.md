# Field gates — when we may advance

Public checklist so we do not skip straight from docs to household dependency.
...
| **G5-A Advice (reviewed)** | Enrolled WhatsApp/SMS with rates (L2) | Named reviewer on WHO **or** qualified review date; ADVICE_SCRIPTS says L2 open; [AI_FIELD_PATH.md](../AI_FIELD_PATH.md) |
| **G5-B Instant + experts** | Instant field AI (L3) | G5-A done; expert path + SLA; safe/unsafe topics published |
